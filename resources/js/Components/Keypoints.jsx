          ...
          <div>
              <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-md md:shadow-indigo-300/50  p-10">
                      <span><ChatBubbleBottomCenterTextIcon  className="w-12 text-blue-800"/></span>
                      <h1 className="font-bold text-lg text-blue-800">Transparency</h1>
                  ...
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-md md:shadow-indigo-300/50 p-10">
                      <span><ClockIcon  className="w-12 text-blue-800"/></span>
                      <h1 className="font-bold text-lg text-blue-800">On-time delivery </h1>
                  ...
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-md md:shadow-indigo-300/50 p-10">
                      <span><HandThumbUpIcon  className="w-12 text-blue-800"/></span>
                      <h1 className="font-bold text-lg text-blue-800">Trust-Worthy</h1>
