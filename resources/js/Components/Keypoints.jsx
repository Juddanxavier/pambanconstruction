...
export default function Keypoints() {
  return (
      <div className=" mb-20 grid md:grid-cols-2 gap-12 p-10 md:p-20 divide divide-y">
          <div className="flex flex-col justify-center items-center">
              <span className="text-slate-800 font-bold text-4xl"> What sets our company apart from our competitors?</span>
          ...
          <div>
              <div className="grid md:grid-cols-2 gap-12">
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-sm md:shadow-indigo-300/50 p-10">
                      <span><CheckBadgeIcon  className="w-12 text-indigo-800"/></span>
                      <h1 className="font-bold text-lg text-indigo-800">Quality</h1>
                  ...
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-md md:shadow-indigo-300/50  p-10">
                      <span><ChatBubbleBottomCenterTextIcon  className="w-12 text-indigo-800"/></span>
                      <h1 className="font-bold text-lg text-indigo-800">Transparency</h1>
                  ...
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-md md:shadow-indigo-300/50 p-10">
                      <span><ClockIcon  className="w-12 text-indigo-800"/></span>
                      <h1 className="font-bold text-lg text-indigo-800">On-time delivery </h1>
                  ...
                  <div className="bg-white w-100 h-64 rounded-sm md:shadow-md md:shadow-indigo-300/50 p-10">
                      <span><HandThumbUpIcon  className="w-12 text-indigo-800"/></span>
                      <h1 className="font-bold text-lg text-indigo-800">Trust-Worthy</h1>
