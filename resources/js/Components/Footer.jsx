...
<footer className="p-4 md:mt-10 sm:p-6 bg-indigo-900">
    <div className="md:flex pt-10 pb-20 md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">General</h2>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-white sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <Link href="https://pambanconstructions.com/" className="hover:underline">Pamban Constructions</Link>. All Rights Reserved.
        </span>
