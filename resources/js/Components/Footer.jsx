...
<footer className="p-4 lg:mt-8 sm:p-6 dark:bg-gray-900">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <Link href="https://pambanconstructions.com/" className="hover:underline">Pamban Constructions</Link>. All Rights Reserved.
        </span>
