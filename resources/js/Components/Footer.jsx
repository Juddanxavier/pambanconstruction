...
<footer className="p-4 lg:mt-8 sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="https://pambanconstructions.com/" className="flex items-center">
                <img src={logo} className="mr-3 h-16 grayscale hover:grayscale-0" alt="Pamban constructions Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <a href="https://pambanconstructions.com/" className="hover:underline">Pamban Constructions</a>. All Rights Reserved.
        </span>
