...
function Hometile() {
    return (
        <m.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true, amount:0.25}} className="container grid md:grid-cols-2 lg:grid-cols-3 gap-4 p-10 md:p-20 mx-auto">
            <m.div variants={fadeIn("down")} className="relative overflow-hidden h-96 rounded-3xl bg-red-100 flex flex-col justify-center px-10">
                <img
            ...
            <m.div variants={fadeIn("down")} className="relative overflow-hidden h-96 rounded-3xl bg-green-100 lg:col-span-2 flex flex-col justify-center px-10">
                <img
            ...
            <m.div variants={fadeIn("down")} className="relative overflow-hidden h-96 rounded-3xl bg-indigo-100 lg:col-span-2 flex flex-col justify-center px-10">
                <img
                    className="h-96 w-96 absolute -right-36 hover:-translate-x-4 duration-700 opacity-20"
                    src={Medal}
                    alt="Medal"
            ...
            <m.div variants={fadeIn("down")} className="relative overflow-hidden h-96 rounded-3xl bg-fuchsia-100 flex flex-col  justify-center px-10">
                <img
